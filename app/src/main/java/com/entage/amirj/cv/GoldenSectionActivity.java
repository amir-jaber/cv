...
public class GoldenSectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), GoldenSectionAlgorithm.class));
            }
        });
        ...
        solve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ed_text.isEmpty() || ed_text2.isEmpty() || ed_text3.isEmpty()){
                    ...
                    double i = goldenSection.findMin(a, b, e, funk_number);
                    double k = goldenSection.findMax(a, b, e, funk_number);
