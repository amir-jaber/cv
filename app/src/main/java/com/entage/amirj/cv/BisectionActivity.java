...
public class BisectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.functions_bisection, android.R.layout.simple_spinner_item);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                switch (position){
                    case 0:
                        ...
                        flower.setImageResource(R.drawable.graph1bisection);
                        break;
                    case 1:

                        funk_number = position;
                        flower.setImageResource(R.drawable.graph2bisection);
                        break;
                    case 2:

                        funk_number = position;
                        flower.setImageResource(R.drawable.graph3bisection);
                        break;
                }
            }
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), BisectionAlgorithm.class));
            }
        });
        ...
        solve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ed_text.isEmpty() || ed_text2.isEmpty() || ed_text3.isEmpty()){
                    ...
                    double i = bisection.findMin(a, b, e, funk_number);
                    double k = bisection.findMax(a, b, e, funk_number);
